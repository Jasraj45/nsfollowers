...
class Ns_Followers:
    def __init__(self):
        ...
        self.__username='jasraj_972' #Enter UserName Here
        self._session='66793972325:C4xIbhKUFOiOuH:28:AYf9ikhXYqZxiGEIPyzhVJci2ZUH855NivkjtQ05eg' #Enter SessionID Here
